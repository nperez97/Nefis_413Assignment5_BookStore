...
namespace BookStore.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index(string category, int pageNum = 1) //pretend two is passed in
        {
            ...
            return View(new BookListViewModel
            {
                Books = _repository.Books
                    ...
                    .Skip((pageNum - 1) * PageSize) //2-1. then does 1 times 20 (assuming we set it to 20)
